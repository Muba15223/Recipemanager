...
const MyRecipes = () => {
  ...
  useEffect(() => {
    const fetchMyRecipes = async () => {
      try {
        ...
        const response = await axios.get("https://recipemanager-ma43.onrender.com/my-recipes", {
  ...
  const handleDeleteRecipe = async (recipeId) => {
    try {
      ...
      await axios.delete(`https://recipemanager-ma43.onrender.com/recipes/${recipeId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
